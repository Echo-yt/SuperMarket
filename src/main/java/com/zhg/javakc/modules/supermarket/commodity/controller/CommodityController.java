...
public class CommodityController {
    ...
    public String query(CommodityEntity entity, ModelMap model,
        ...
        List<TypeEntity>typeList =typeService.queryAll();
    ...
    @ResponseBody
    public List<TypeEntity> queryType(String typeFirst, ModelMap modelMap) {
        List<TypeEntity>secondList=typeService.queryType(typeFirst);
