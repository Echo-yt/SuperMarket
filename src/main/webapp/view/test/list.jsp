		...
		<div class="wrapper wrapper-content animated fadeInRight">
			<div class="ibox float-e-margins">
				...
				<div class="col-sm-12">
	                ...
	                <div class="col-sm-4">
	                	<input class="form-control" id="search" name="testName" autocomplete="off" value="${testEntity.testName }" type="text" placeholder="查询内容 回车搜索"/>
	                </div>
	                 <!-- ------------按钮组 end------------ -->
					        ...
					        <tbody>
					        	...
					        	<c:forEach var="e" items="${page.list }" varStatus="v">
						            <tr>
						                ...
						                <td>${e.testName}</td>
						                <td>${e.testSex=="1"?"男":e.testSex=="2"?"女":"保密"}</td>
